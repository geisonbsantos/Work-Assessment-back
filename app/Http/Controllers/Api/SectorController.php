...
class SectorController extends CrudController
{
    ...
    protected function beforeStore(StoreUpdateSectorFormRequest $request): JsonResponse
    {
        $request->validated();
    ...
    protected function beforeUpdate(StoreUpdateSectorFormRequest $request, string $uuid): JsonResponse
    {
        $request->validated();
